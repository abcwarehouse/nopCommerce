    ...
    function g(c) {
        a("img[data-lazy]", c).each(function() {
            var c = a(this),
                ...
                // Check screen width and use data-lazy-mobile if available and screen is <= 768px
                src = (window.innerWidth <= 768 && c.attr("data-lazy-mobile")) ? c.attr("data-lazy-mobile") : d,
                e = document.createElement("img");
            
            e.onload = function() {
                c.animate({ opacity: 0 }, 100, function() {
                    c.attr("src", src).animate({ opacity: 1 }, 200, function() {
                        c.removeAttr("data-lazy data-lazy-mobile").removeClass("slick-loading");
                    }),
                    b.$slider.trigger("lazyLoaded", [b, c, src]);
                });
            },
            e.onerror = function() {
                c.removeAttr("data-lazy data-lazy-mobile").removeClass("slick-loading").addClass("slick-lazyload-error"), 
                b.$slider.trigger("lazyLoadError", [b, c, src]);
            },
            e.src = src;
        });
    }
