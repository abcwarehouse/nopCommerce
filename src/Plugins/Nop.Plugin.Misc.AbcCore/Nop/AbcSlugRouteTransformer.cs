...
namespace Nop.Plugin.Misc.AbcCore.Nop
{
    ...
    /// </summary>
    public class AbcSlugRouteTransformer : DynamicRouteValueTransformer
    {
        #region Fields
        ...
        public AbcSlugRouteTransformer(IEventPublisher eventPublisher,
        ...
        public override async ValueTask<RouteValueDictionary> TransformAsync(HttpContext httpContext, RouteValueDictionary values)
        {
            ...
            {
                case "product":
                    // ABC: This is what's modified from original file
