        ...
        private async System.Threading.Tasks.Task<string> GetRebatePromoHtmlAsync(Topic rootTopic)
        {
            ...
            foreach (var promo in promos)
            {
                ...
                var promoDescription = promo.ManufacturerId != null ?
                                ...
                                promo.Description;
                html += $"<div class=\"abc-item abc-promo-item\"> fhjkdlsaf jklsadlkjsdalksdajf lksdaf lksdafsdlka fjsdalk fsdalk" +
                        $"<a href=\"/promos/{await _urlRecordService.GetActiveSlugAsync(promo.Id, "AbcPromo", 0)}\"> " +
                        $"{promoDescription}fhjkdlsaf jklsadlkjsdalksdajf lksdaf lksdafsdlka fjsdalk fsdalk </a><br />" +
                        $"Expires {promo.EndDate.ToString("MM-dd-yy")}fhjkdlsaf jklsadlkjsdalksdajf lksdaf lksdafsdlka fjsdalk fsdalk" +
                        "</div>";
            }
